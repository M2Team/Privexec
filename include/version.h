...
#define PRIVEXEC_MARJOR_VERSION 2
#define PRIVEXEC_MINOR_VERSION 1
#define PRIVEXEC_PATCH_VERSION 0

#ifdef APPVEYOR_BUILD_NUMBER
#define PRIVEXEC_BUILD_VERSION L"2.1.0." PRIVSUBVER L" (appveyor)"
#else
#define PRIVEXEC_BUILD_VERSION L"2.1.0." PRIVSUBVER L" (dev)"
#endif
